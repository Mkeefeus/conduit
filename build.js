...
if (process.argv.includes('-s') || process.argv.includes('--skip-prompt')) {
  updateJson(jsonData._meta.sources[0].version);
} else {
  prompt.start();
  prompt.get(
    {
